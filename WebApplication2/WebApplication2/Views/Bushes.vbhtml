@Inherits Nancy.ViewEngines.Razor.NancyRazorViewBase(Of WebApplication2.Model.BushesModel)
...
End Section
    ...
    <table>
        ...
        @For Each bush As WebApplication2.Model.BushModel In Model.Bushes
            @<tr>
                <td>@bush.Id</td>
